...
let createTwitterDataSet = 
    ...
    let rel2 = DataRelation("SUBER_USER", twitterData.Tables.["USERS"].Columns.["USERNAME"], twitterData.Tables.["SUBSCRIBERS"].Columns.["SUBSCRIBER"])
    ...
    twitterData.Tables.["SUBSCRIBERS"].ParentRelations.Add(rel2)
